...
[![GoDoc](https://godoc.org/github.com/anaxita/telebot?status.svg)](https://godoc.org/github.com/anaxita/telebot)
...
```bash
go get -u github.com/anaxita/telebot
```
...
[here](https://godoc.org/github.com/anaxita/telebot#pkg-constants).
...
implementations:
```go
import "github.com/anaxita/telebot/middleware"
```
...
[here](https://pkg.go.dev/github.com/anaxita/telebot#Option).
